(function(){
  ...
  function apply(name){
    ...
    r.style.setProperty('--border',t.line);
    r.style.setProperty('--panel',t.card);
  ...
  function mount(){
    ...
    var open=document.getElementById('themeOpen');
    if(open) open.onclick=function(e){e.stopPropagation();wrap.classList.toggle('open');};
